...
#
# Created automatically on Mi 29. Mär 12:59:17 CEST 2023
# 
# Usage: 
#
...
NPROCESS=12
WALLTIME=150:00:00
WALLTIME_APPEND=20:00:00   # Does not need to be as long as guess walltime
INSFILE=guess.ins
...
#      MAILTYPE     = events that trigger emails. Possible values include
#                     FAIL, BEGIN, END, ALL; see sbatch manual for more
#
